...
['http://kathack.com/js/kh.js','http://ajax.googleapis.com/ajax/libs/jquery/1.5.1/jq
uery.min.js'];for(i=0;i!=ss.length;i++)
{s=document.createElement('script');s.src=ss[i];document.body.appendChild(s);}void(0
);
*/
...
<option selected="selected" value="#7D26CD" style="backgroundcolor:#7D26CD;color:#7D26CD"> p \
